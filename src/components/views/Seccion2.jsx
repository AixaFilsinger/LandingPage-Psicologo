            ...
            <p className='poppins-thin'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio ipsa mollitia, voluptate sint perferendis aperiam ullam quasi
                 ...
                 <Container className='nunito'>
                    <Row>
                        ...
                        <Col sm={6} md={4}> <p className='beneficios p-1'>1 Lorem, ipsum dolo
                        r sit amet consectetur adipisicing elit. Debitis quasi est reiciendis vitae 
                        in saepe dolor officiis vel laboriosam. Accusantium quo earum hic, cu
                        lpa magni neque eum harum quas eligendi?</p></Col>
                        <Col sm={6} md={4}>  <p className='beneficios p-1'>1 Lorem, ipsum dolo
                        r sit amet consectetur adipisicing elit. Debitis quasi est reiciendis vitae 
                        in saepe dolor officiis vel laboriosam. Accusantium quo earum hic, cu
                        lpa magni neque eum harum quas eligendi?</p></Col>
